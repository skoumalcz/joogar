...
/*!
 ...
 and <code>nextValue</code> method. Example usage: 
@code
...
/*!
 @param inArg JSON encoded string. Null is not permitted and will yield a
 tokener that throws <code>NullPointerExceptions</code> when methods are
 called.
 */
- (instancetype)initWithNSString:(NSString *)inArg;

/*!
 @brief Unreads the most recent character of input.
 If no input characters have
...
/*!
 ...
 The return value of this method is ambiguous
 for JSON strings that contain the character '\0'.
 */
- (jchar)next;

/*!
 @brief Returns the next available character if it equals <code>c</code>.
 Otherwise an
 exception is thrown.
 */
...
/*!
 ...
 a comment.
 If the input is exhausted before such a character can be
...
/*!
 ...
 <code>thru</code>.
 If the remaining input doesn't contain <code>thru</code>, the
 input is exhausted.
 */
...
/*!
 ...
 <code>to</code>.
 If the remaining input doesn't contain <code>to</code>, the input
 is unchanged.
 */
