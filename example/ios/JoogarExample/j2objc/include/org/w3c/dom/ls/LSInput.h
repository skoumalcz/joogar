...
/*!
 ...
 The application must encode the stream
...
/*!
 @brief String data to parse.
 If provided, this will always be treated as a
...
/*!
 ...
 input source.
 The system identifier is optional if there is a byte
...
/*!
 @brief The public identifier for this input source.
 This may be mapped to an
...
/*!
 @brief The character encoding, if known.
 The encoding must be a string
