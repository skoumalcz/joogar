...
/*!
 ...
 source.
 This <code>DOMConfiguration</code> is specific to the parse
...
/*!
 @brief Parse an XML document from a location identified by a URI reference [<a href='http://www.ietf.org/rfc/rfc2396.txt'>IETF RFC 2396</a>].
 If the URI
...
/*!
 ...
 <code>action</code> arguments.
 When parsing the input stream, the
...
/*!
 @brief Abort the loading of the document that is currently being loaded by
 the <code>LSParser</code>.
 If the <code>LSParser</code> is currently
