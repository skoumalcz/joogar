...
/*!
 ...
 resets the parser.
 The event type is set to the initial value
 START_DOCUMENT.
...
/*!
 ...
 <p><b>NOTE:</b> to retrieve list of namespaces declared in current element:
@code
...
/*!
 ...
 event.
 See getText(), next() and nextToken() for description of possible returned values.
...
/*!
 @brief Get next parsing event - element content wil be coalesced and only one
...
@endcode
 <p>for input document that contained:
@code
