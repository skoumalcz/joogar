...
/*!
 ...
 diagnosis XML validity errors.  The constructors <code>namespaceURI,String localPart) QName(String
...
/*!
 ...
 specification, it is in common use,  e.g. <code>name,Object value)</code>.
