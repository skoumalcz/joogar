...
/*!
 ...
 @throws IllegalArgumentException if <code>factoryClassName</code> is not available, cannot be
...
/*!
 ...
 @param schemas
 inputs to be parsed. <code>SchemaFactory</code> is required
 to recognize <code>StreamSource</code>,
