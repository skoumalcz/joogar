...
@interface JavaIoStreamTokenizer : NSObject {
 ...
 token that has been read.
   When a single character is read, its value
 converted to an integer is stored in <code>ttype</code>. For a quoted string,
...
/*!
 ...
 stream.
 This constructor is deprecated; instead, the constructor that
...
/*!
 ...
 @param flag
 <code>true</code> if EOL is significant, <code>false</code> otherwise.
 */
...
/*!
 ...
 @param flag
 <code>true</code> if <code>sval</code> should be converted to lower
 case, <code>false</code> otherwise.
 */
- (void)lowerCaseModeWithBoolean:(jboolean)flag;

/*!
 @brief Parses the next token from this tokenizer's source stream or reader.
 The
...
/*!
 ...
 That is, it has no special meaning as a
...
/*!
 ...
 @param flag
 <code>true</code> if <code>//</code> should be recognized as the start
 of a comment, <code>false</code> otherwise.
 */
