...
/*!
 ...
 traversed in either ascending or descending order.  The <code>descendingSet</code>
 ...
 lowest and highest element, if one exists, else returning <code>null</code>
 .  Methods <code>subSet</code>, <code>headSet</code>,
 and <code>tailSet</code> differ from the like-named <code>SortedSet</code>
  methods in accepting additional arguments describing
 whether lower and upper bounds are inclusive versus exclusive.
 Subsets of any <code>NavigableSet</code> must implement the <code>NavigableSet</code>
  interface.
...
/*!
 ...
 <code>fromElement</code> to <code>toElement</code>.
 If <code>fromElement</code> and
 <code>toElement</code> are equal, the returned set is empty unless <code>fromExclusive</code>
  and <code>toExclusive</code> are both true.  The returned set
