...
@endcode
 ...
 <tt>tryAcquire</tt> to immediately return <tt>false</tt> if <code>getFirstQueuedThread</code>
  does not return the current thread.  A
 normally preferable non-strict fair version can immediately return
 <tt>false</tt> only if <code>hasQueuedThreads</code> returns
...
@endcode
 <p>Here is a latch class that is like a <code>CountDownLatch</code>
...
/*!
 @brief Creates a new <tt>AbstractQueuedSynchronizer</tt> instance
...
/*!
 ...
 Implements <code>AbstractQueuedSynchronizer.getWaitingThreads</code>.
 @return the collection of threads
 @throws IllegalMonitorStateException if <code>isHeldExclusively</code>
 returns <code>false</code>
 */
...
/*!
 ...
 this condition.
 Implements <code>AbstractQueuedSynchronizer.getWaitQueueLength</code>.
 @return the estimated number of waiting threads
 @throws IllegalMonitorStateException if <code>isHeldExclusively</code>
 returns <code>false</code>
 */
...
/*!
 ...
 Implements <code>AbstractQueuedSynchronizer.hasWaiters</code>.
