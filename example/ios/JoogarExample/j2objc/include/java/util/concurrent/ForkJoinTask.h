...
/*!
 ...
 performing only the (possibly) blocking action. (3) Unless the <code>ForkJoinPool.ManagedBlocker</code>
 ...
 and <code>RecursiveTask</code> for those that do. Normally, a concrete
...
/*!
 ...
 @since 1.8
 */
- (jboolean)compareAndSetForkJoinTaskTagWithShort:(jshort)e
                                        withShort:(jshort)tag;
...
/*!
 ...
 <code>join</code> and related operations.
 ...
 thrown will be a <code>RuntimeException</code> with cause <code>ex</code>.
 */
...
/*!
 ...
 current task is running in, if applicable, or using the <code>ForkJoinPool.commonPool()</code>
  if not <code>inForkJoinPool</code>.
 While
...
/*!
 @brief Completes this task normally without setting a value.
 The most
...
/*!
 ...
 exception.
 This method may be useful when processing
...
/*!
 @brief Atomically sets the tag value for this task.
 @param tag the tag value
 @return the previous value of the tag
 @since 1.8
 */
- (jshort)setForkJoinTaskTagWithShort:(jshort)tag;

/*!
 @brief Tries to unschedule this task for execution.
 This method will
...
/*!
 ...
 Availability may be transient, so a
...
/*!
 @brief Forces the given value to be returned as a result.
 This method
...
/*!
 @brief Cancels, ignoring any exceptions thrown by cancel.
 Used during
...
/*!
 @brief Primary execution method for stolen tasks.
 Unless done, calls
...
/*!
 @brief If lock is available, poll stale refs and remove them.
...
/*!
 @brief Tries to set SIGNAL status unless already completed.
 Used by
 ForkJoinPool. Other variants are directly incorporated into
 externalAwaitDone etc.
 @return true if successful
 */
- (jboolean)trySetSignal;
...
/*!
 ...
 This implements RunnableFuture
