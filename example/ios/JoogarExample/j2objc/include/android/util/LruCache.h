...
/*!
 ...
 For all other caches, this returns the
...
/*!
 ...
 <code>remove</code>, or replaced by a call to <code>put</code>. The default
 implementation does nothing.
 <p>The method is called without synchronization: other threads may
 access the cache while this method is executing.
 @param evicted true if the entry is being removed to make space, false
 if the removal was caused by a <code>put</code> or <code>remove</code>.
 @param newValue the new value for <code>key</code>, if it exists. If non-null,
 this removal was caused by a <code>put</code>. Otherwise it was caused by
 an eviction or a <code>remove</code>.
 */
